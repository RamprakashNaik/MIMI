          ...
          <div style={{ marginTop: '0.75rem', display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
            ...
            {res.results?.map((hit: any, i: number) => (
              <div key={i} style={{ background: 'var(--bg-deep)', padding: '0.75rem', borderRadius: '0.5rem' }}>
                <a href={hit.url} target="_blank" rel="noopener noreferrer" style={{ fontSize: '0.8rem', color: 'var(--accent-glow)', textDecoration: 'none', fontWeight: 600, display: 'block', marginBottom: '0.25rem' }}>
                  {hit.title}
                </a>
